...
describe UsersController do
  ...
  describe "GET 'index" do
    ...
    describe "for signed in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :name => "Bob", :email => "another@somewhere.com")
        third = Factory(:user, :name => "Bill", :email => "nobody@anywhere.com")
  ...
  describe "GET 'show'" do
    ...
    it "should show user's microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "YABBA DABBA")
      mp2 = Factory(:micropost, :user => @user, :content => "WOO DOO")
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {  :email => "user@example.com", :name => "Modified Man", 
